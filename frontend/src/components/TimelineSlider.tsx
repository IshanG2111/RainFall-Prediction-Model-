...
export default function TimelineSlider() {
  ...
  return (
    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[600px] max-w-[90vw] z-10">
      <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-2xl p-4 shadow-2xl flex flex-col gap-4">
        ...
        <div className="relative pt-2 pb-6">
          <div className="h-1.5 w-full bg-slate-800 rounded-full relative">
            <div 
              className="absolute top-0 left-0 h-full bg-gradient-to-r from-sky-600 to-sky-400 rounded-full"
