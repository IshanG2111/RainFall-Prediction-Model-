...
MASTER_DIR = os.path.join(BASE_DIR, "data_processed", "8_days", "master_daily")
FINAL_DIR = os.path.join(BASE_DIR, "data_processed", "8_days", "finaldata")
