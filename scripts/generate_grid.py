...
def generate_grid(lat_start=6.0, lat_end=38.0,
                  lon_start=68.0, lon_end=98.0,
                  step=0.25):
    ...
    df = pd.DataFrame(grid_cells, columns=[
        "grid_id", "lat_min", "lat_max",
        "lon_min", "lon_max",
        "lat_center", "lon_center"
    ])

    out_dir = "../data_processed/2_days/grid"
